...
for sbj_id = 1:1%num_sbjs
    ...
    for ch = 1:num_chs
        ...
        [ft_sbj_newfts_ch_pre_sleep, stp_ftepcs_new_pre_sleep] = parfor_process_epochs(num_epcs_total_pre_sleep, ...
        ...
        [ft_sbj_newfts_ch_start_rec, stp_ftepcs_new_start_rec] = parfor_process_epochs(num_epcs_total_start_rec, ...
